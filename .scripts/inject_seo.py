...
PAGES = {
    "hessa.html": (
        ...
        "منصّة استثمار إسلامية متوافقة مع الشريعة. شارك في مشاريع رؤية ٢٠٣٠ عبر عقود المرابحة، التحقق الرقمي، وإشراف هيئة شرعية معتمدة.",
    ),
    "projects.html": (
        "المشاريع — مُرابحة",
    ...
    "auth.html": (
        ...
        "سجّل الدخول إلى مُرابحة بكل أمان، أو أنشئ حساباً جديداً لتكون من أوائل المستثمرين فور إطلاق الفرص الاستثمارية.",
    ),
    "portfolio.html": (
        "محفظتي — مُرابحة",
    ...
    "contract.html": (
        ...
        "نموذج عقد المرابحة المعتمد من الهيئة الشرعية، عشر مواد متوافقة مع الشريعة الإسلامية والتوقيع الإلكتروني.",
    ),
    "help.html": (
